...
// console.log(makeTransaction(10, 500, 5000)); // "You ordered 10 dro

function makeTransaction(quantity, pricePerDroid, customerCredits) {
	let totalPirce = quantity * pricePerDroid;

	if (customerCredits / quantity >= pricePerDroid) {
		return `You ordered ${quantity} droids worth ${totalPirce}  credits!`;
	}
